...
const PILLARS = [
  { icon: <FileCheck className="h-6 w-6" />, t: "Обработка по поручению\n(152-ФЗ)", d: "TalentMind обрабатывает данные по поручению клиента: оператором и ответственным за согласие кандидата выступает сам клиент. В оферте закреплено, что, загружая запись, клиент подтверждает наличие согласия по 152-ФЗ. Клиентам выдаём памятку, как его корректно получить", a: GREEN },
  ...
  return (
    <div ref={root}>
      <section className="mx-auto max-w-[1100px] px-6 pt-40 pb-12 text-center">
        ...
        <div className="reveal mt-9 flex justify-center"><CTA href="/contacts">Запросить демо безопасности</CTA></div>
      </section>
